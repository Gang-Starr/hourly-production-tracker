...

{
  ...
  assert.match(content.html, /<tr><td style="font-family:Arial,sans-serif;font-size:16px;font-weight:700;mso-bidi-font-weight:bold;line-height:1\.3;padding:0 0 20px 0;">SCHICHTÜBERGABE<\/td><\/tr>/);
